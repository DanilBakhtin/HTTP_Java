...
public class HttpClient {
    ...
    /**
     * Метод из потока считывает в массив данных и преобразует его в строку, после чего полученная строка возвращается
     */
    ...
    /**
     * Метод зз заголовка получает порт и хост, после чего создается сокет и возращвается ответ из него(вызов метода getAnswer)
     */
    ...
    /**
     * Метод создает поток записи для сокета, записанный поток считывается и преобразовывается в строку и возвращается.
     */
    ...
    /**
     * Вычленяет из адреса хост и возвращает его в качетсве строки, если в строке нет "Host: ", то возвращает "localhost".
     */
    ...
    /**
     * Вычленяет номер порта из хоста
     */
    ...
    /**
     * Вычленяет из хоста номер порта
     */
